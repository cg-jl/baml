...
class TypeBuilder(type_builder.TypeBuilder):
    ...
    @property
    def FinalResponseTool(self) -> "FinalResponseToolViewer":
        return FinalResponseToolViewer(self)
...
class FinalResponseToolAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        _tb = tb._tb # type: ignore (we know how to use this private attribute)
        self._bldr = _tb.class_("FinalResponseTool")
        self._properties: typing.Set[str] = set([  "action",  "follow_up_questions",  "response",  ])
        self._props = FinalResponseToolProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "FinalResponseToolProperties":
        return self._props


class FinalResponseToolViewer(FinalResponseToolAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
...
class FinalResponseToolProperties:
    def __init__(self, bldr: baml_py.ClassBuilder, properties: typing.Set[str]):
        self.__bldr = bldr
        self.__properties = properties # type: ignore (we know how to use this private attribute) # noqa: F821
